...
#         input_feature_train_arr = scaler.fit_transform(input_feature_train_df)
#         input_feature_test_arr = scaler.transform(input_feature_test_df)
#         logging.info("Diabetes Disease Prediction: Applying preprocessing on training and testing datasets.")
...
class DataTransformation:
    ...
    def initialize_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Exception occured in initialize_data_transformation")
            raise customexception(e, sys)