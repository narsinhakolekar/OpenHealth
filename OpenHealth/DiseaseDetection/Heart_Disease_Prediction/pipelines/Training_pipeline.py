...
# from OpenHealth.DiseaseDetection.Heart_Disease_Prediction.components.Data_ingestion import DataIngestion
# from OpenHealth.DiseaseDetection.Heart_Disease_Prediction.components.Data_transformation import DataTransformation
# from OpenHealth.DiseaseDetection.Heart_Disease_Prediction.components.Model_trainer import ModelTrainer
# from OpenHealth.DiseaseDetection.Heart_Disease_Prediction.components.Model_evaluation import ModelEvaluation
...
class Heart_Disease:
    ...
    def train_heart(self):
        ...
        x_train, x_test, y_train, y_test = data_transformation.initialize_data_transformation(
            train_data_path,
            test_data_path
        )
        ...
        model_eval_obj.initiate_model_evaluation(
            x_train,
            x_test,
            y_train,
            y_test
